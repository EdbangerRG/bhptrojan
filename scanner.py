...
class IP:
    def __init__(self, buff=None):
        ...
        try:
            self.protocol = self.protocol_map[e, self.protocol_num]
...
#this sprats out UDP diagram with our magic message
def udp_sender():
...
class Scanner:            
    ...
    def sniff(self):
        ...
        # handle CTRL-C
            ...
            if os.name == 'nt':
                self.socket.ioctl(socket_SIO_RCVALL, socket.RCVALL_OFF)
